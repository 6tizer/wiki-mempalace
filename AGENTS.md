...
This project is indexed by GitNexus as **wiki-mempalace** (9296 symbols, 19391 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/wiki-mempalace/context` | Codebase overview, check index freshness |
| `gitnexus://repo/wiki-mempalace/clusters` | All functional areas |
| `gitnexus://repo/wiki-mempalace/processes` | All execution flows |
| `gitnexus://repo/wiki-mempalace/process/{name}` | Step-by-step execution trace |
...
| Work in the Tests area (455 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Commands area (67 symbols) | `.claude/skills/generated/commands/SKILL.md` |
| Work in the Cluster_7 area (62 symbols) | `.claude/skills/generated/cluster-7/SKILL.md` |
| Work in the Cluster_123 area (50 symbols) | `.claude/skills/generated/cluster-123/SKILL.md` |
| Work in the Tui area (34 symbols) | `.claude/skills/generated/tui/SKILL.md` |
| Work in the Cluster_225 area (26 symbols) | `.claude/skills/generated/cluster-225/SKILL.md` |
| Work in the Scripts area (26 symbols) | `.claude/skills/generated/scripts/SKILL.md` |
| Work in the Cluster_8 area (25 symbols) | `.claude/skills/generated/cluster-8/SKILL.md` |
| Work in the Cluster_92 area (25 symbols) | `.claude/skills/generated/cluster-92/SKILL.md` |
| Work in the Cluster_60 area (24 symbols) | `.claude/skills/generated/cluster-60/SKILL.md` |
| Work in the Cluster_11 area (23 symbols) | `.claude/skills/generated/cluster-11/SKILL.md` |
| Work in the Cluster_129 area (22 symbols) | `.claude/skills/generated/cluster-129/SKILL.md` |
| Work in the Cluster_45 area (21 symbols) | `.claude/skills/generated/cluster-45/SKILL.md` |
| Work in the Cluster_83 area (19 symbols) | `.claude/skills/generated/cluster-83/SKILL.md` |
| Work in the Cluster_69 area (18 symbols) | `.claude/skills/generated/cluster-69/SKILL.md` |
| Work in the Cluster_94 area (18 symbols) | `.claude/skills/generated/cluster-94/SKILL.md` |
| Work in the Cluster_236 area (18 symbols) | `.claude/skills/generated/cluster-236/SKILL.md` |
| Work in the Cluster_96 area (17 symbols) | `.claude/skills/generated/cluster-96/SKILL.md` |
| Work in the Cluster_97 area (16 symbols) | `.claude/skills/generated/cluster-97/SKILL.md` |
| Work in the Cluster_79 area (15 symbols) | `.claude/skills/generated/cluster-79/SKILL.md` |
