...
- [production-wiki-compiler.md](production-wiki-compiler.md) — Notion-equivalent local compiler: raw source -> summary + concept/entity pages -> Vault -> outbox -> Mempalace -> query/explain.
