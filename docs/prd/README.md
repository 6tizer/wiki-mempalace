...
- [next-three-closeout-2026-04-30.md](next-three-closeout-2026-04-30.md) — PR #99：stale `vault-report-paths` cleanup, read-only row-state production validation, and scheduled hardening observation.
- [audit-disposition-2026-04-30.md](audit-disposition-2026-04-30.md) — PR #95/#96/#97：2026-04-30 audit disposition follow-up for M-5 MCP query storage ports, L-4 docs consistency, and I-8 MCP API reference refresh.
