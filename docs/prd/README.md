...
- [next-three-closeout-2026-04-30.md](next-three-closeout-2026-04-30.md) — Stale `vault-report-paths` cleanup, read-only row-state production validation, and scheduled hardening observation.
