...
| 轨道 | 状态 | 当前事实 |
| --- | --- | --- |
| Active implementation | 进行中 | Wiki Governance + Evidence Fixer + Multi-provider Synthesis v3 已启动；PR #101/#102 已合入；当前 PR3 为 `codex/evidence-fixer-plan` |
...
| 3 | Evidence Fixer plan | Local complete | 规则 + LLM + 双搜索证据生成 typed fix plan | `codex/evidence-fixer-plan` |
