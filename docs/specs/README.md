...
- [evidence-fixer-plan/](evidence-fixer-plan/) — PR3 for Wiki Governance + Evidence Fixer + Multi-provider Synthesis v3: typed dry-run fixer plan from governance scan evidence. Local complete, pending PR.
