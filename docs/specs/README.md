...
- [audit-v2-11-vault-docs-hardening/](audit-v2-11-vault-docs-hardening/) — Audit Report Follow-up v2 PR 11: Vault projection managed marker/quarantine, docs consistency, and scheduled hardening lane。Active branch `codex/audit-v2-11-vault-docs-hardening`。
