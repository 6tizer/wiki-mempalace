...
- [evidence-fixer-apply-restore/](evidence-fixer-apply-restore/) — PR4 for Wiki Governance + Evidence Fixer + Multi-provider Synthesis v3: evidence-auto apply, tombstones, and restore. Local complete, pending PR.
